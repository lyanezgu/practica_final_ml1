...
**Random Forest:** Con un accuracy obtenido entorno al 76% y un AUC de aproximadamente un 93%.
...
**XGBoost:** Con un accuracy obtenido entorno al 79% y un AUC de aproximadamente un 89%.
...
```{r}
#GLM
#pred.glm <- prediction(predict.glm, train_glm$nota_vino)
#pref.glm <- (pred.glm, "tpr", "fpr")
#plot(pref1, col = "blue", lwd = 2)


``` 

# 14. Comprobación del mejor modelo con datos de test
